...
public class FeedClient {
	...
	public static void main(String[] args) throws IOException {
		...
		//File entryFile = new File ("C:\\Temp\\output\\CodeSystem-ODS-PrimaryRoleScope-20200626_Entry.json");
		//File bodyFile = new File("C:\\Temp\\output\\CodeSystem-ODS-PrimaryRoleScope-20200626.json");
		//feedClient.createEntryToNHSFeed(entryFile,bodyFile);
		System.out.println(feedClient.searchEntryByIdentifierAndVersion("http://fhir.hl7.org.uk/CodeSystem/OPCS-4",	"48"));
	}
